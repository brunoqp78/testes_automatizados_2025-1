...
public class PessoaTests {
    /**
     * <p>
     * <b>Autor:</b> Bruno Queiroz
     * </p>
     * <p>
     * <b>Cenário:</b> Testa o construtor com um nome válido minúsculo, no meio dos
     * limites
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = "bruno"
     * </p>
     * <p>
     * <b>Saída esperada:</b> "BRUNO"
     * </p>
     */
    @Test
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa o construtor com um nome válido minúsculo, no limite
     * inferior de 2 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = "Ed"
     * </p>
     * <p>
     * <b>Saída esperada:</b> "ED"
     * </p>
     */
    @Test
     ...
     * <p>
     * <b>Cenário:</b> Testa o construtor com um nome válido minúsculo, no limite
     * superior de 100 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = Bruno Queiroz
     * 12345678901234567890123456789012345678901234567890123456789012345678901234567890123456
     * </p>
     * <p>
     * <b>Saída esperada:</b> BRUNO QUEIROZ
     * 12345678901234567890123456789012345678901234567890123456789012345678901234567890123456
     * </p>
     */
    @Test
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa o construtor com um nome inválido minúsculo, acima do
     * limite superior de 100 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = Bruno Queiroz
     ...
     * </p>
     * <p>
     * <b>Saída esperada:</b> IllegalArgumentException
     * </p>
     * <p>
     * <b>Mensagem esperada:</b> "Nome inválido, precisa ter entre 2 e 200
     * caracteres."
     * </p>
     */
    @Test
    public void testarConstrutorComNomeInvalidoAcimaLimiteSuperior() {
        ...
        // act
        String mensagemObtida = assertThrows(IllegalArgumentException.class, () -> {
            new Pessoa(nomeInvalido);
        }).getMessage();
        // assert
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa o construtor com um nome inválido minúsculo, abaixo do
     * limite inferior de 2 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = b
     * </p>
     * <p>
     * <b>Saída esperada:</b> IllegalArgumentException
     * </p>
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa a modificação com um nome válido minúsculo, no meio dos
     * limites
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = "bruno"
     ...
     */
    @Test
    public void testarModificarNomeValidoDentroDosLimites() {
        // assign
        String nomeValido = "bruno";
        String saidaEsperada = "BRUNO";
        Pessoa pessoa = new Pessoa();
        // act
        pessoa.setNome(nomeValido);
        String saidaObtida = pessoa.getNome();
        // assert
        assertEquals(saidaEsperada, saidaObtida);
    }
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa a modificação de um nome válido minúsculo, no limite
     * inferior de 2 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = "Ed"
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa modificar um nome válido minúsculo, no limite superior
     * de 100 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = Bruno Queiroz
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa a modificação de um nome inválido minúsculo, acima do
     * limite superior de 100 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = Bruno Queiroz
    ...
    /**
     * <p>
     * <b>Cenário:</b> Testa a modificação de um nome inválido minúsculo, abaixo do
     * limite inferior de 2 caracteres
     * </p>
     * <p>
     * <b>Entrada:</b> nomeValido = b
